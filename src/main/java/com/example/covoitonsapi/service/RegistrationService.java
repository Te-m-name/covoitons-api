...
public class RegistrationService implements IRegistrationService {
    ...
    public String confirmToken(String token) {
        ConfirmationEntity confirmationToken = confirmationService
                .getToken(token)
                .orElseThrow(() ->
    ...
    private String buildEmail(String name, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "        \n" +
                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + name + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> Merci pour votre enregistrement et bienvenue sur Covoitons. Cliquez sur le lien ci-dessous pour confirmer votre compte: </p><blockquote style=\"Margin:0 0 20px 0;border-left:10px solid #b1b4b6;padding:15px 0 0.1px 15px;font-size:19px;line-height:25px\"><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> <a href=\"" + link + "\">Activer maintenant</a> </p></blockquote>\n Le lien expore dans 1h. <p>A bientôt !</p>" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                "    </tr>\n" +
